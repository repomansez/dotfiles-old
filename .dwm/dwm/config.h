...
static const char cuzinpeludo[]     = "#1a1a1a";
static const char cuzinpeludo1[]    = "#494942";
...
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col_fg_bar, cuzinpeludo, col_gray2 },
...
static Key keys[] = {
	...
	{ 0|ShiftMask,			XK_Print,    spawn,   SHCMD("maim -u -s | xclip -selection clipboard -t image/png") },	
	{ 0|ControlMask,	        XK_Print,    spawn,   SHCMD("maim -u $HOME/$(date +%s).png") },
	{ 0|ControlMask|ShiftMask,      XK_Print,    spawn,   SHCMD("maim -u -s $HOME/$(date +%s).png") },
	
	/* audio bindings */
	{ MODKEY|ShiftMask,		XK_v,			 spawn, SHCMD("chvol") },
	{ 0,				XF86XK_AudioMute,        spawn, SHCMD("amixer set Master toggle") },
	
	/* MPD bindings */
	{ 0,				XF86XK_AudioPlay,        spawn, SHCMD("mpc toggle") },
	{ 0,				XF86XK_AudioRaiseVolume, spawn, SHCMD("mpc volume +2") },
	{ 0,				XF86XK_AudioLowerVolume, spawn, SHCMD("mpc volume -2") },
